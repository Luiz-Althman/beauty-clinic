...
export function SectionService() {
    return (
        <section className="flex flex-col justify-center items-center my-45 md:my-30">
            ...
            <div className="md:grid grid-cols-3 gap-15 hidden">
                {services.map((service) => (
                    ...
                    >
                        ...
                        <div
                            id="price"
                            className="bg-white/85 w-[235px] h-[150px] flex justify-center items-center absolute inset-0 m-auto"
                        >
